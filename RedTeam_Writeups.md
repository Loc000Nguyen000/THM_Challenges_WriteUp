...
+ Got a CVE, we need to reformat the code to exploit it but we can now inject (almost) any php code we want. No direct rce here, we can’t get any interaction with system via php
